#!/usr/bin/env python3
"""
Hybrid ALFA-Transformer Training Script v4.9 (EURUSD Target)
=============================================================
- Includes EURUSD in the download list, as it is the target pair for trading.
- The list now contains the 6 essential cross pairs + the target pair (EURUSD),
  for a total of 7, which is the minimum required for the EA's features.
- Includes all previous definitive fixes for data loading and attributes.
"""
import os
...
# --- DATA DOWNLOADER (7 Pairs for EURUSD Trading) ---
# This list includes the target pair (EURUSD) plus the 6 essential
# cross pairs required by the MQL5 feature formulas.
CURRENCY_PAIRS = [
    "EURUSD=X", # The target pair we want to trade
    "GBPUSD=X",
    "USDJPY=X",
    "USDCAD=X",
    "USDCHF=X",
...
def download_all_data():
    """Downloads a 3-month chunk of 1-hour data for fast testing."""
    print("🚀 Starting 3-MONTH TEST data download for the 7-pair EURUSD set...")
...
# --- MODEL ARCHITECTURE and other helpers (No changes needed) ---
...
# --- MAIN EXECUTION ---
def main():
    print("🚀 Hybrid ALFA-Transformer Training Script v4.9 (EURUSD Target)")
    print("=" * 70)
    ...
    for currency_pair_name, main_df in all_data.items():
        ...
        try:
            ...
            main_df_processed, features_df = create_mql5_features(main_df_aligned, aligned_all_data, currency_pair_name)
